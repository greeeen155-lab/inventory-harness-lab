  ...
  const P = await Promise.all(
    (
      [
        ...
        ['VEGAN-COOKIE-STRAWBERRY-40', '비건쿠키 딸기 40g', 60],
        ['VEGAN-COOKIE-CARROT-40', '비건쿠키 당근 40g', 60],
        ['VEGAN-COOKIE-BLUEBERRY-40', '비건쿠키 블루베리 40g', 60],
        ['VEGAN-COOKIE-SWEETPOTATO-40', '비건쿠키 고구마 40g', 60],
